# Custom script to import custom vuln csv file of users

 Set-ADDefaultDomainPasswordPolicy -Identity $Global:Domain ComplexityEnabled $false -MinPasswordLength 4

$Csvfile = "C:\Scripts\ad_users_vuln.csv"
